        ...
        <Link href={`/projects/${project.id}`}>
          <Card glow className="group cursor-pointer">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              >
                <span className="text-xs font-bold font-mono text-foreground/30 group-hover:text-foreground/50 transition-colors">
  ...
  return (
    ...
    >
      <Link href={`/projects/${project.id}`} className="block h-full">
        <Card glow className="group cursor-pointer h-full flex flex-col">
          <div
            className={cn(
          ...
          >
            {project.thumbnail ? (
              ...
              <span className="text-3xl font-bold font-mono text-foreground/10 group-hover:text-foreground/20 transition-colors">
                {project.code.slice(0, 3)}
              </span>
            )}
          </div>
          ...
          <CardContent className="p-4 space-y-3 flex-1 flex flex-col">
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                <p className="text-sm font-semibold text-foreground group-hover:text-indigo-300 transition-colors leading-snug">
                  {project.name}
                </p>
